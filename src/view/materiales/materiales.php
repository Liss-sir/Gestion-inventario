...
// ✅ NECESARIO: si NO inicias sesión, no puedes leer permisos del usuario
if (session_status() === PHP_SESSION_NONE) {
  session_start();
}

// ✅ Helpers de permisos (TU SISTEMA)
require_once __DIR__ . "/../../utils/permisos_helper.php";

// ✅ Permiso: SOLO mostrar "Nuevo Material" si puede crear o gestionar materiales
$canCrearMaterialBtn = canPermiso("materiales.crear") || canPermiso("materiales.gestionar");
    ...
    <div class="space-y-6 animate-fade-in-up">
      ...
      <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div class="flex items-center gap-3">
          ...
          <!-- ✅ Nuevo material button (SOLO si tiene permiso) -->
          <?php if ($canCrearMaterialBtn): ?>
            <button
              id="btnNuevoMaterial"
              type="button"
