...
<body class="bg-background text-foreground">
    ...
    ==================================== -->
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
            ...
            <button id="sol-btn-nueva" class="sol-btn-primary inline-flex items-center gap-2">
            ...
            <form id="sol-form-nueva">
                ...
                <div id="sol-paso-1" class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea id="observaciones" name="observaciones" class="input-siga w-full" rows="3"
                    ...
                    <div>
                        ...
                        <div class="flex flex-col sm:flex-row gap-3 mt-2">
                            ...
                            <div class="flex gap-2">
                                <input type="number" id="material-cantidad" class="input-siga w-20" value="1" min="1">
